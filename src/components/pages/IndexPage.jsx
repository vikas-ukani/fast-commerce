        ...
        <>
            <div className="bg-cover bg-no-repeat bg-center py-36" style={{ backgroundImage: "url('assets/images/banner-bg.jpg'" }}>
                <div className="container">
                    ...
                    <p>Home Decor - Buy Home Decor Products online to decorate your home beautifully. <br />
                        Explore our wide range of wall stickers, photo frames, clocks & more.</p>
                    <div className="mt-12">
                ...
                <div className="grid grid-cols-3 gap-4">
                    {categories?.slice(0, 6)?.map((category, idx) => (
                        <div key={idx} className="relative rounded-lg overflow-hidden group">
                            <Image width={500} height={500} src={category.images[1]} alt="category 1" className="w-full h-full object-contain" />
                            <Link href={`/${category.title}/products`}
                                className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-4xl text-white font-bold group-hover:bg-opacity-60 transition capitalize">
