                ...
                <div className="container flex text-sm">
                    ...
                    <div className="flex items-center justify-between flex-grow md:pl-12 py-1 ">
                        <div className="flex items-center space-x-1 capitalize ">
                            <Link href={'/'} className={`${router.asPath == '/' ? 'bg-primary' : ''} text-gray-200 px-4 py-2 rounded-lg ease-in-out hover:text-white transition`}>Home</Link>
                            <Link href={'/products'} className={`${router.asPath.startsWith('/product') || router.asPath.endsWith('/products') ? 'bg-primary' : ''} text-gray-200 px-4 py-2 rounded-lg ease-in-out  hover:text-white transition`}>Shop</Link>
                            <a href="#" className="text-gray-200 hover:text-white px-4 py-2 rounded-lg ease-in-out transition">About us</a>
                            <a href="#" className="text-gray-200 hover:text-white px-4 py-2 rounded-lg ease-in-out transition">Contact us</a>
                        </div>
